...
CONCEPTS = [
    ...
    ReplayConcept(
        ...
        ["bm25", "naive bm25", "discard bm25", "retrieval primitive", "candidate generator"],
        ["bm25", "discard bm25", "naive", "precision", "retrieval primitive"],
    ...
    ReplayConcept(
        ...
        ["helper-lazy", "helper lazy", "helper librarian", "alias brain", "profile brain"],
        ["helper-lazy", "helper lazy", "librarian helping", "alias", "metadata", "profile"],
    ...
    ReplayConcept(
        ...
        ["spec dd lazy", "spec decode", "mtp", "draft sidecar", "speculative", "sub ms"],
        ["spec decode", "mtp", "spec-dd", "spec dd", "speculative", "draft", "lazy"],
    ),
    ReplayConcept(
        "confidence_gate",
        "gate",
        ...
        ["confidence gate", "early exit", "when to deploy librarian", "activate librarian", "gated deterministic"],
        ["confidence", "gate", "deploy the librarian", "activate the librarian", "early exit", "confidence answers"],
    ),
    ReplayConcept(
        "distillation_loop",
        "distill",
        ...
        ["distillation loop", "learns user patterns", "brain that learns", "post deployment", "teach deterministic"],
        ["learns", "patterns", "distill", "post deployment", "brain", "user patterns", "future similar"],
    ),
    ReplayConcept(
        "librarian_role",
        "librarian",
    ...
    ReplayConcept(
        ...
        ["1700 cases", "simulated environment", "real world oriented", "black box", "edge cases"],
        ["1700", "simulated", "real world", "black box", "edge", "internal benchmark"],
    ),
    ReplayConcept(
        "real_replay_testing",
        "replay",
    ...
    ReplayConcept(
        ...
        ["signal", "signalcli", "phone ping", "pings via signal", "push reply"],
        ["signal", "signalcli", "phone", "ping", "notify", "tailscale"],
    ),
    ReplayConcept(
    ...
    ReplayConcept(
        ...
        ["startup", "saas", "revenue", "users", "product", "github stars"],
        ["startup", "saas", "revenue", "users", "product", "commercial"],
    ),
    ReplayConcept(
        "codex_opencode_logs",
        "codex",
        ...
        ["codex chatlogs", "opencode chatlogs", ".config/opencode", ".codex sessions", "jsonl"],
        ["codex logs", "chatlogs", "opencode", ".config", ".codex", "sessions"],
    ),
    ReplayConcept(
        "worktree_branch",
        "worktree",
        ...
        ["worktree", "main", "branch", "push commits", "merge", "pr"],
        ["worktree", "branch", "merge", "push", "pr", "main"],
    ),
]
